...
* **Tools:** Work with a "Reasoning Model" (like **o3-mini** in GPT or [DeepSeek](https://chat.deepseek.com/)) so you can "see what the LLM is thinking," or write a prompt instructing the model to explain its moves.
